...
\lstinline|@play20.welcome(message)| ist ein Aufruf eines von Play mitgelieferten Helpers, der die in Abb.~\ref{fig:anwendung_nach_erstellung} abgebildete Seite generiert.
...
In diesem Template werden durch Aufrufe wie \lstinline[breaklines=true]|@routes.Assets.at("javascripts/jquery-1.9.0.min.js")| Dateien aus dem \lstinline|public/|-Ordner adressiert \cite[vgl.][S.~136]{play_for_scala_v8}.
