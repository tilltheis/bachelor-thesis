...
Grundlagen mit den bisherigen Quellen \citealt{play_for_scala}.
...
Der Anwendungscode einer Play-Applikation ist nach der Model-View-Controller-Architektur aufgebaut.
...
Klickt ein(e) Webseitenbesucher(in) beispielsweise auf den Link eines Nutzerprofils, so generiert der Web-Browser eine HTTP-Anfrage, die an den von Play verwendeten Web-Server gesendet wird.
