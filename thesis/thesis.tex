...
So muss in aller Regel, sofern überhapt nötig, nur noch der erste Typ-Parameter angegeben werden.
...
\begin{lstlisting}[caption=Erstellung eines \lstinline|Enumeratee|s durch die \lstinline|map|-Konstruktormethode, label=lst:enumerateeerstellung_durch_companion_konstruktormethode]
...
\begin{lstlisting}[caption=Sequentielle Komposition von \lstinline|Iteratee|s, label=lst:sequentielle_komposition_von_iteratees]
...
\begin{lstlisting}[caption=Sequentielle Komposition von \lstinline|Iteratee|s mit \lstinline|for|-Comprehension, label=lst:sequentielle_komposition_von_iteratees_mit_for_comprehension]
...
\begin{lstlisting}[caption=Parallele Komposition von \lstinline|Iteratee|s, label=lst:parallele_komposition_von_iteratees]
val i1: Iteratee[Int, Option[Int]] = Iteratee.head
val i2: Iteratee[Int, Int] = Iteratee.fold(0)(_ + _)
