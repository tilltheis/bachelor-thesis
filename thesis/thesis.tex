...
\begin{enumerate}
  ...
  \item Durch Benutzung einer Konstruktorfunktion analog zu den \lstinline|Step|-Zuständen (\lstinline|Done|, \lstinline|Cont| oder \lstinline|Error|).
...
Die erste Variante ist von \lstinline|Iteratee| zu erben und die \lstinline|fold|-Method zu implementieren.
...
Sobald keine weiteren Elemente mehr kommen können, wird die Berechnung beendet und in den \lstinline|Done|-Zustand übergegangen.
