...
Kovarianz bedeutet, dass wenn \lstinline|F| ein spezialisierter Typ von \lstinline|E| ist, dann ist \lstinline|Input[F]| auch ein spezialisierter Typ von \lstinline|Input[E]| \cite[vgl.][S.~11]{variance}.
...
Ein \lstinline|Enumerator| sendet selber kein \lstinline|Input.EOF|-Element, wenn er keine Elemente mehr hat, sodass es möglich ist, noch einen weiteren \lstinline|Enumerator| auf ein \lstinline|Iteratee| anzuwenden.
