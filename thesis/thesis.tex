...
Iteratees, Enumerators und Enumeratees mit den bisherigen Quellen \citealt{kiselyov2012} \cite[vgl.][]{kiselyov2012} und \citealt{drobi2012} \cite[vgl.][]{drobi2012}.


\section{Serverseitig} % (fold)
\label{sec:serverseitig}


\subsection{Futures und Promises} % (fold)
\label{ssec:futures_und_promises}

Futures und Promises mit den Quellen \citealt{haller2013} und \citealt{typesafe2013}.

% subsection futures_und_promises (end)


\subsection{Streams} % (fold)
\label{ssec:streams}
