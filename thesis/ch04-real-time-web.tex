...
Dies, so vermutet der Author, wird der Grund sein, weshalb o.~g. \lstinline|Enumeratee| übergebene \lstinline|String|s in doppelte Anführungszeichen setzt (\lstinline[mathescape]|"$\ldots$"|), sobald eine \lstinline|String|-Nachricht an den Client gesendet wird.
