...
\subsection{Web-Sockets auf der Client-Seite} % (fold)
...
\subsection{Web-Sockets auf der Server-Seite} % (fold)
...
\subsection{Server Sent Events auf der Client-Seite} % (fold)
...
Dieses beobachtete Verhalten ist ein Bug und wird zum Abgabezeitpunkt dieser Arbeit noch diskutiert \cite[vgl.][]{play_eventsource_bug}.
